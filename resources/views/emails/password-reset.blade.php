...
<head>
    ...
    <title>{{ __('app.password_reset.email_subject') }}</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #4F46E5; color: white; padding: 20px; text-align: center; border-radius: 8px 8px 0 0;">
        ...
        <p style="margin: 10px 0 0 0;">{{ __('app.password_reset.email_subject') }}</p>
    </div>
    
    <div style="background-color: #f9fafb; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
        <h2 style="color: #1f2937; margin-top: 0;">{{ __('app.password_reset.email_greeting') }}</h2>
        ...
        <p>{{ __('app.password_reset.email_outro') }}</p>
        ...
        <p style="color: #6b7280; font-size: 14px; margin-top: 30px;">
            {{ __('app.password_reset.email_ignore') }}
        </p>
    </div>
    
    <div style="text-align: center; margin-top: 20px; color: #9ca3af; font-size: 12px;">
        <p>Leafmark - {{ __('app.password_reset.email_footer') }}</p>
    </div>
</body>
</html>

        ...
        <form method="POST" action="{{ route('books.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="page_count" id="page_count" min="0" value="{{ old('page_count') }}"
            ...
            <div>
                ...
                <input type="text" name="language" id="language" maxlength="10" placeholder="e.g., en, de" value="{{ old('language') }}"
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('books.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-2 px-6 rounded-lg">
                    Cancel
                </a>
